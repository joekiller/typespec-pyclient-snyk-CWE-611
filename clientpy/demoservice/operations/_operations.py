...
def build_widgets_list_request(**kwargs: Any) -> HttpRequest:
...
def build_widgets_read_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_widgets_create_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_widgets_update_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class WidgetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~demoservice.DemoServiceClient`'s
    ...
    def list(self, **kwargs: Any) -> _models.WidgetList:
        """List widgets.
    ...
    def read(self, id: str, **kwargs: Any) -> _models.Widget:
        """Read widgets.
    ...
    @overload
    def create(self, body: _models.Widget, *, content_type: str = "application/json", **kwargs: Any) -> _models.Widget:
        """Create a widget.
    ...
    @overload
    def create(self, body: JSON, *, content_type: str = "application/json", **kwargs: Any) -> _models.Widget:
        """Create a widget.
    ...
    @overload
    def create(self, body: IO[bytes], *, content_type: str = "application/json", **kwargs: Any) -> _models.Widget:
        """Create a widget.
    ...
    def create(self, body: Union[_models.Widget, JSON, IO[bytes]], **kwargs: Any) -> _models.Widget:
        """Create a widget.
    ...
    def analyze(self, id: str, **kwargs: Any) -> _models.AnalyzeResult:
        """Analyze a widget.
